...
This project uses SQLite for persistence. On startup the application will attempt to perform *safe, additive* migrations to the `products` table so deployments can be upgraded in-place. Read this file before upgrading production.
